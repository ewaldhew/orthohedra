...
bool testFloatNbhoodReprComplement()
{
    cout << "------------------------- ";
    cout << "testFloatNbhoodReprComplement:" << endl;
...
bool testFloatNbhoodRepr()
{
    if (!testFloatNbhoodReprMembership_datafiles()) {
        return false;
    }
    if (!testFloatNbhoodReprFacet()) {
        return false;
    }
    if (!testFloatNbhoodReprComplement()) {
        return false;
    }
    if (!testFloatNbhoodReprBooleanOperations()) {
        return false;
    }
    return true;
}
