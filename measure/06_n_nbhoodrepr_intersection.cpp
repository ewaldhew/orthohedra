...
{   
    ...
    vector<NbhoodRepr> generatedPolyhedra;
    ...
    for (int i = 0; i < MAX_NR_OF_TRIVIALS; i ++) {
        ...
        generatedPolyhedra.push_back(nr);
    }

    ////////////////////////////////////////////////////////////////////////

    for (int i = 0; i < generatedPolyhedra.size() - 1; i ++) {
        int vertexCnt = generatedPolyhedra[i].getVertexesWithNbhood().size();

        clock_t begin = clock();
        /////////////////////
        generatedPolyhedra[i].intersection(generatedPolyhedra[i + 1]);
        /////////////////////
        clock_t end = clock();
